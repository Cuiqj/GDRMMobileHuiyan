...
//        self.labelLocality.text = locality;
        ...
        roadName = caseInfo.roadName;
        station_start_km = caseInfo.station_start_km;
        station_start_m = caseInfo.station_start_m2;
...
//        NSString *dateString = NSStringFromNSDateAndFormatter(caseInfo.happen_date, NSDateFormatStringCustom1);
        ...
        NSString *dateString2 = self.labelDraftTime.text;
        dateData2 = DateDataFromDateString(dateString2);
        dateData2 = (dateData2 == nil ? @{} : dateData2);
...
//            eventReason = NSStringNilIsBad(proveInfo.case_short_desc);
    ...
    return @{
             ...
             @"weater":weater,
             @"roadName":roadName,
             @"station_start_km":station_start_km,
